            ...
            <Row gutter={24}>
              ...
              <Col span={12}>
                <Descriptions bordered>
                  ...
                  <Descriptions.Item label="Description" span={3}>get user email</Descriptions.Item>
                  <Descriptions.Item label="Website Link" span={3}>get website link</Descriptions.Item>
                  <Descriptions.Item label="Social Media Links" span={3}>get social media</Descriptions.Item>
                  <Descriptions.Item label="Address" span={3}>get user address</Descriptions.Item>
                  <Descriptions.Item label="Category" span={3}>get user category</Descriptions.Item>
                </Descriptions>
              </Col>
            </Row>
